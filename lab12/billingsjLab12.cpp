 ...
 */
int main() {
    //Declare a scores array of length SCORES_COUNT (2)
    Scores scoresList[SCORES_COUNT];
    ...
    cout << "Here are the averages for each Scores object." << endl;

    //Iterate through the array again to print the averages
    for (unsigned int i = 0; i<SCORES_COUNT; i++) {
        cout << "The average for student " << i + 1 << " is " << scoresList[i].getAverage() << "." << endl;
    }
}